    ...
    <div>
      ...
      <div style={{ padding: "6rem 3rem" }}>
        ...
        <p>
          ...
          dieser Website im Sinne der Datenschutz-Grundverordnung (DSGVO) sind
          Feres Jammali und Karim Jemmali, Scorpmedia, Nikolaistra&szlig;e 32,
          30159 Hannover, Deutschland, Tel.: 01636009519, E-Mail:
          info@scorpmedia.de. Der f&uuml;r die Verarbeitung von
        ...
        <br />
        <p>
          <b>1.3</b>&nbsp;Diese Website nutzt aus Sicherheitsgr&uuml;nden und
        ...
        <p>
          ...
          unseren Server &uuml;bermittelt (sog. &bdquo;Server-Logfiles&#8220;).
        ...
        <p>
          ...
          vorgegebenen Dauer gel&ouml;scht, die sich je nach Cookie
          unterscheiden kann.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          Wir arbeiten unter Umst&auml;nden mit Werbepartnern zusammen, die uns
          helfen, unser Internetangebot f&uuml;r Sie interessanter zu gestalten.
          Zu diesem Zweck werden f&uuml;r diesen Fall bei Ihrem Besuch unserer
          ...
          Werbepartnern zusammenarbeiten, werden Sie &uuml;ber den Einsatz
          derartiger Cookies und den Umfang der jeweils erhobenen Informationen
          innerhalb der nachstehenden Abs&auml;tze individuell und gesondert
          informiert.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          >
            ...
            /tempor
            <wbr />
            &auml;res-zulassen-von-cookies-und-website-daten-in-microsoft-edge-597f04f2-c0ce-f08c-7c2b-541086362bd2
          </a>
          <br />
          Firefox:{" "}
          <a
        ...
        <p>
          ...
          Administration gespeichert und verwendet. Rechtsgrundlage f&uuml;r die
          Verarbeitung dieser Daten ist unser berechtigtes Interesse an der
          Beantwortung Ihres Anliegens gem&auml;&szlig; Art. 6 Abs. 1 lit. f
          DSGVO. Zielt Ihre Kontaktierung auf den Abschluss eines Vertrages ab,
          so ist zus&auml;tzliche Rechtsgrundlage f&uuml;r die Verarbeitung Art.
          6 Abs. 1 lit. b DSGVO. Ihre Daten werden nach abschlie&szlig;ender
